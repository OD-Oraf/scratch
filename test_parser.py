...
for change in changes:
    print(f"Artifact:     {change['artifact']}")
    print(f"Group ID:     {change['groupId']}")
...
# Save to file
with open('confluence-content-preview.html', 'w') as f:
    f.write(html_content)

# Save changes as JSON
with open('changes-preview.json', 'w') as f:
    json.dump(changes, f, indent=2)

print("=" * 80)
print("CONFLUENCE HTML PREVIEW")
print("=" * 80)
print(html_content)
print()
print("Files created:")
print("  - confluence-content-preview.html")
print("  - changes-preview.json")
